...
module.exports = {
    run: (interaction ,bot) => {
        ...
        try {
            ...
            console.log("│ ERRO │ Usuário em user foi expulso recentemente. Não foram recolhidos dados.");
            interaction.reply({ content: "**❌ Esse membro foi expulso ou banido recentemente. Não sou capaz de acessar mais dados sobre ele.**", ephemeral: true })
        }
    },
